  ...
  return (
    <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden mt-0">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900/90 via-indigo-900/85 to-purple-900/90 z-10"></div>
        {/* Replace with actual image: */}
        <div className="w-full h-full bg-gradient-to-br from-blue-800 via-indigo-700 to-purple-800">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">Uni-Vivamus</span>
          </motion.h1>
