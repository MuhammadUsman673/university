...
export default function LeedsPage() {
  const location = locationData.leeds;
  return (
      ...
      <section className="py-16 text-white" style={{ background: 'linear-gradient(to bottom right, #355E47, #2D5F3F)' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/programs" className="px-6 py-2.5 rounded-lg font-semibold text-sm transition-all shadow-xl hover:opacity-90" style={{ backgroundColor: 'white', color: '#355E47' }}>Browse Programs</a>
